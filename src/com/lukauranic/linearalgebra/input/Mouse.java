package com.lukauranic.linearalgebra.input;
...
public class Mouse implements MouseListener, MouseMotionListener{
	private static int x = LinearAlgebra.WIDTH / 2, y = LinearAlgebra.HEIGHT / 2;
	...
	public void mouseDragged(MouseEvent e) {
		x = (int) (e.getX() / LinearAlgebra.scale);
		y = (int) (e.getY() / LinearAlgebra.scale);		
	}
